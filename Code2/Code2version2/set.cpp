...
//Conversion constructor
Set::Set(int n)
	: Set() //Call constructor insead of writing code inside constructor again
{
	//Insert given value to set
	insert(tail, n);
}
...
>>>>>>> c40392d116bcedbecf1583de5b6b16bf703a3f76:Code2/Code2version2/set.cpp
