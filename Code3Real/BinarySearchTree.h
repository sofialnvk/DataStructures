...
class BinarySearchTree
{
  ...
  private:
	...
	void insert(const Comparable & x, BinaryNode * & t, const BinaryNode * parent)
	{
		if (t == nullptr)
	...
	void insert(Comparable && x, BinaryNode * & t, const BinaryNode * parent)
	{
		if (t == nullptr)
	...
	/* void insert(const Comparable & x, BinaryNode * & t)
	{
		...
		else if (x < t->element)
		{
			insert(x, t->left);
			t = t->left;
			BinaryNode* lchild = new BinaryNode{ x, t->left, t->right, t->parent };
			//lchild = insert(x, t->left);
			t->left = lchild;
		...
		else if (t->element < x)
		{
			insert(x, t->right);
			t = t->right;
			BinaryNode* rchild = new BinaryNode{ x, t->left, t->right, t->parent };
			t->right = rchild;
	...
	* Set the new root of the subtree.
	...
	void insert(Comparable && x, BinaryNode * & t)
	{
		...
		{
			//insert( x, t->left );
			BinaryNode* lchild = insert(std::move(x), t->left);
			t->left = lchild;
			//Set parent of root of left subtree
			lchild->parent = t;
		}
		...
		{
			//insert( x, t->right );
			BinaryNode* rchild = insert(std::move(x), t->right);
			t->right = rchild;
			//Set parent of root of right subtree
			rchild->parent = t;
		}
